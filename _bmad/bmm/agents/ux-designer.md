...
<activation critical="MANDATORY">
    ...
    <rules>
      ...
      <r>SESSION CONTINUITY: After completing each workflow step and saving to document, ALWAYS provide a copy-paste ready continuation prompt for the user to start a fresh session. This keeps context clean across long workflows. Include: agent name, document paths, completed steps, next step, key decisions summary, and user preferences.</r>
    </rules>
</activation>  <persona>
