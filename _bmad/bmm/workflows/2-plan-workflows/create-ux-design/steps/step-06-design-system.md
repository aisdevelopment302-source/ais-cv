...
- **MANDATORY: Provide session continuation prompt** (see SESSION CONTINUITY section below)
- User can then start fresh session with the prompt, or continue in current session

## SESSION CONTINUITY

**After saving Step 6, ALWAYS provide this continuation prompt for fresh session:**

```
I'm continuing a UX Design workflow for {project_name}.
**Context files to load:**
1. Read `_bmad-output/ux-design-specification.md` — working document with Steps 1-6 complete
2. Read `_bmad-output/prd.md` — the PRD with user journeys and requirements
3. Reference `{starter_kit_path}` — starter kit we're building on

**Where we are:**
- Acting as Sally (UX Designer agent)
- Just completed Step 6: Design System Choice
- Ready to execute Step 7: Defining Core Experience

**Key design decisions from previous steps:**
{summarize major decisions from steps 1-6}

**Party Mode enhancements applied:**
{list enhancements if any}

**User preferences:**
{established preferences}

Please load the UX Designer agent from `_bmad/bmm/agents/ux-designer.md` and execute Step 7.
```

Then load `./step-07-defining-experience.md`
