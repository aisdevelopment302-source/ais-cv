...
**After saving Step 7, ALWAYS provide this continuation prompt for fresh session:**

```
I'm continuing a UX Design workflow for {project_name}.
**Context files to load:**
1. Read `_bmad-output/ux-design-specification.md` — working document with Steps 1-7 complete
...
- Just completed Step 7: Defining Core Experience
- Ready to execute Step 8: Visual Foundation

**Key design decisions from previous steps:**
{summarize major decisions from steps 1-7}
...
Please load the UX Designer agent from `_bmad/bmm/agents/ux-designer.md` and execute Step 8.
```

Then load `./step-08-visual-foundation.md`
